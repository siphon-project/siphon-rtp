...
| AMR-NB | `AMR` (dynamic) | all 8 modes | MR475, MR515, MR59, MR67, MR74, MR122 | 3GPP TS 26.074 vectors | `amr` |
...
(5.15 kbit/s), MR59 (5.90 kbit/s), MR67 (6.70 kbit/s), MR74 (7.40 kbit/s) and MR122
(12.2 kbit/s, the GSM-EFR-equivalent mode); a `mode-set` that forces one of the
remaining two modes is declined cleanly at call setup rather than mis-encoding mid-call.
That is enough for AMR-NB to G.711 transcoding in both directions; the remaining encoder
modes are in progress.
